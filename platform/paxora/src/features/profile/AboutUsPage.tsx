...
const MILESTONES = [
  { year: '2017', event: 'Founded', description: 'PAXORA is established with a vision for accessible global trading.' },
...
export function AboutUsPage() {
  useDocumentTitle('About Us · PAXORA');
  ...
  return (
    <div className="pb-24 md:pb-12 md:max-w-4xl md:mx-auto">
      <div className="sticky top-0 z-30 bg-background/80 backdrop-blur-2xl md:bg-transparent md:backdrop-blur-none px-6 pt-16 pb-2 md:pt-10 md:px-0">
        ...
        <PageHeader
          title="About Us"
          subtitle="The story behind PAXORA"
          action={
      ...
      <div className="px-6 md:px-0 space-y-10 mt-4">
        ...
        <Section delay={0.4}>
          ...
          <div className="rounded-[24px] border border-[#3B82F6]/20 bg-[#3B82F6]/5 backdrop-blur-xl p-6 text-center">
            ...
            <h3 className="text-lg font-black text-foreground mb-2">paxoralab.com</h3>
