        ...
        <div className="px-3 sm:px-4 pb-12 sm:pb-20">
          <div className="mx-auto w-full max-w-2xl space-y-8 p-5 sm:p-8 rounded-3xl bg-surface border border-white/5 shadow-2xl">
            ...
            <div className="space-y-5 sm:space-y-6 text-sm sm:text-[15px] text-muted-foreground leading-[1.65] sm:leading-relaxed">
              <p>
                These Terms of Service (&quot;Terms&quot;) govern your access to and use of the Paxora platform, website, and related services. By creating an account or using our services, you agree to be bound by these Terms.
              </p>
              ...
              <section>
                ...
                <p>
                  To the maximum extent permitted by law, Paxora, its affiliates, directors, and employees shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill, arising from your use of the platform.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  The Paxora name, logo, platform design, and all related intellectual property are owned by Paxora. You may not reproduce, distribute, or create derivative works without our prior written consent.
                </p>
              </section>
