        ...
        <div className="px-3 sm:px-4 pb-12 sm:pb-20">
          <div className="mx-auto w-full max-w-2xl space-y-8 p-5 sm:p-8 rounded-3xl bg-surface border border-white/5 shadow-2xl">
            ...
            <div className="space-y-5 sm:space-y-6 text-sm sm:text-[15px] text-muted-foreground leading-[1.65] sm:leading-relaxed">
              <p>
                Paxora (&quot;Paxora,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform, website, and services.
              </p>
              ...
              <section>
                ...
                <p className="mt-2">To exercise these rights, contact us at <span className="text-primary font-bold">Support@paxoralab.com</span>. We will respond within 30 days.</p>
              </section>
