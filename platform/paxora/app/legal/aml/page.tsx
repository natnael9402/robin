          ...
          <div className="mx-auto w-full max-w-2xl space-y-8 p-5 sm:p-8 rounded-3xl bg-surface border border-white/5 shadow-2xl">
            ...
            <div className="space-y-5 sm:space-y-6 text-sm sm:text-[15px] text-muted-foreground leading-[1.65] sm:leading-relaxed">
              ...
              <section>
                ...
                <p>PAXORA maintains a zero-tolerance policy toward money laundering, terrorist financing, and any form of financial crime. We are fully committed to:</p>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-1 mt-2">
                  <li>All directors, officers, employees, and contractors of PAXORA</li>
                  <li>All products, services, and activities offered through the PAXORA platform</li>
                  <li>All users, customers, and counterparties accessing or using our services</li>
                  <li>All geographic locations and jurisdictions in which PAXORA operates or provides services</li>
                </ul>
              ...
              <section>
                ...
                <p>PAXORA has appointed a designated AML Compliance Officer (&ldquo;AMLCO&rdquo;) who holds ultimate responsibility for the implementation and oversight of this AML Policy. The AMLCO reports directly to senior management and the Board of Directors.</p>
              ...
              <section>
                ...
                <p>PAXORA implements risk-based Customer Due Diligence procedures for all customers. CDD is conducted at the time of account opening and on an ongoing basis as required.</p>
              ...
              <section>
                ...
                <p>PAXORA maintains a robust framework for the identification and management of Politically Exposed Persons. Our PEP procedures include:</p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <section>
                ...
                <p>PAXORA operates a comprehensive transaction monitoring system designed to detect and flag potentially suspicious activity in real time and on a post-transaction basis.</p>
                ...
                <p>For cryptocurrency transactions, PAXORA utilizes advanced blockchain analytics tools to trace the provenance of funds and identify exposure to:</p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <section>
                ...
                <p>Any employee or officer of PAXORA who becomes aware of any activity that may indicate money laundering, terrorist financing, or other financial crime must immediately report their concerns to the AMLCO.</p>
                ...
                <p>PAXORA prohibits any form of retaliation, discrimination, or adverse action against any employee who reports suspicious activity in good faith. Reports may be made anonymously through our whistleblower channel.</p>
              </section>
              ...
              <section>
                ...
                <p>PAXORA maintains comprehensive records in accordance with applicable legal and regulatory requirements:</p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <section>
                ...
                <p>PAXORA is committed to full compliance with applicable economic sanctions and trade embargoes administered by:</p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <section>
                ...
                <p>PAXORA is committed to ensuring that all employees and relevant contractors receive appropriate AML/CFT training commensurate with their roles and responsibilities.</p>
              ...
              <section>
                ...
                <p>PAXORA conducts a comprehensive enterprise-wide risk assessment at least annually, or more frequently if significant changes occur in our business, customer base, or regulatory environment.</p>
              ...
              <section>
                ...
                <p>PAXORA exercises caution and due diligence in all relationships with third parties, including:</p>
                <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <section>
                ...
                <p className="mt-2">Customers found to have violated AML/CFT requirements may have their accounts suspended or terminated, funds frozen pending investigation, and relevant authorities notified. PAXORA reserves the right to report any suspicious activity to appropriate authorities without prior notice to the customer.</p>
              </section>
              ...
              <section>
                ...
                <p className="mt-2 text-foreground">
                  Email: <span className="text-primary font-bold">Support@paxoralab.com</span><br />
                  Address: Paxora Ltd., Gibraltar<br />
                  Attention: AML Compliance Officer
                </p>
                <p className="mt-2">Whistleblower reports may be submitted anonymously through our dedicated channel at <span className="text-primary font-bold">Support@paxoralab.com</span>.</p>
              </section>
            </div>
